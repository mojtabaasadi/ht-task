import React,{ memo, SyntheticEvent, useId, useState,MouseEvent } from "react";
  ...
  return (<>
    ...
    className="fixed top-0 left-0 h-dvh w-dvw flex flex-col items-center justify-center dimmer">
      <dialog open className="bg-white dark:bg-gray-800 rounded-lg text-black dark:text-white p-3 min-w-1/2">
        ...
        <button className="bg-blue-200 dark:bg-blue-800 p-3 rounded-sm my-1">Misinformaion</button>
        <button className="bg-blue-200 dark:bg-blue-800 p-3 rounded-sm my-1">Fake news</button>
        <button className="bg-blue-200 dark:bg-blue-800 p-3 rounded-sm my-1">Hate Speech</button>
        </div>
